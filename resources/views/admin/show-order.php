...
if(isset($_POST['id_show'])) {
    $order = $order->getOrderById($_POST['id_show']);
}else {
                                        ...
                                        <div class="col-md-12">
                                            <div class="card my-5">
                                                <div class="card-header bg-white text-center p-3">
                                                    <h3 class="text-dark">
                                                        <div>
                                                            <img src="public/images/website/logoSite.png" width="70" alt="">
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                    <p class="lead">
                                                        Order par l'utilisateur : <b class="text-primary"><?= $order->nom_user; ?></b>.
                                                    </p>
                                                    <p class="lead">
