...
if (isset($_POST['Ajouter'])) {
    $pertmateriel->addPerteMaterielle();
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title">Ajouter matériel perte</h5>
                            </div>
                            <div class="card-body">
                                <form method="POST" >
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <?= isset($valid['description_mat']) ? 'is-valid' : '' ?>" placeholder="Enter Description"><?= $description_mat ?></textarea>
