            ...
            <ul class="nav user-menu">
                <!-- <li class="nav-item dropdown language-drop me-2">
                    <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                        <img src="resources/views/admin/assets/img/icons/header-icon-01.svg" alt="">
                    </a>
                ...
                <li class="nav-item dropdown has-arrow new-user-menus">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="public/images/admin/<?= $adminInfo->admin_profile ?>" width="31"
                    ...
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img src="public/images/admin/<?= $adminInfo->admin_profile ?>" alt="User Image"
